...
<main class="form-signin">
  <form action="" method="POST">
    ...
    <h5 class=" mb-3 fw-normal">Login Anggota</h5>
    ...
    <p><a href="/sertifikasi/page_anggota_user/daftar_anggota.php">Registrasi menjadi User</a></p>
    <p><a href="/sertifikasi/login.php">Login Sebagai Admin</a></p>
...
if( isset($_POST['submit']))
{
    include "../koneksi.php";
			...
			$qry	= mysqli_query($db,"SELECT * FROM tbanggota WHERE nama = '$nama' ");
			$sesi	= mysqli_num_rows($qry);

			if ($sesi == true)
			{
				$data_anggota			= mysqli_fetch_array($qry);
				$_SESSION['anggota'] 		= $data_anggota['nama'];
				
                echo "<script>alert('Anda berhasil Log In');</script>";
                header("Location:/sertifikasi/page_anggota_user/menu_user.php");
				// echo "<meta http-equiv='refresh' content='0; url=index.php?user=$sesi'>";
			}
			else
			{
				echo "<meta http-equiv='refresh' content='0; url=/sertifikasi/page_anggota_user/login_anggota.php'>";
